...
<nav class="navbar" id="insidenav">
  <div class="container-fluid">
      <div class="navbar-header">
          <a class="navbar-brand" href="#">JOB NOVA</a>
      </div>

    <ul class="nav navbar-nav">
      <li class="active"><a data-toggle="tab" href="#main1">Home</a></li>
        <li><a data-toggle="tab" href="#recent"">Recent Jobs</a></li>
      <li><a data-toggle="tab" href="#jobseeker">Job Applicants</a></li>
      <li><a data-toggle="tab" href="#">Employers</a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="jobseeker/register_user.php">Job Applicants</a></li>
        ...
        <div class="col-sm-4">
            <div class="panel panel-default text-center">
                ...
                <div class="panel-footer">
                    <h3>$5</h3>
                    <h4>per month</h4>
                    <button class="btn btn-lg enabled">Upgrade</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container bg-grey" id="contact">
        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <p><span class="glyphicon glyphicon-map-marker"></span> West Bengal, India</p>
                <p><span class="glyphicon glyphicon-phone"></span> 8509332887</p>
                <p><span class="glyphicon glyphicon-envelope"></span> info@JOBNOVA.com</p>
            </div>
